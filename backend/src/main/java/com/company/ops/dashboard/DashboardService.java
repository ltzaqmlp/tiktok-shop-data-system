...
public class DashboardService {
    ...
    public Map<String,Object> ads(Scope scope){
        ...
        out.put("trend",db.rows("select biz_date date,sum(spend) spend,sum(attributed_revenue) attributed_revenue from fact_ad_campaign_daily"+WHERE+" group by biz_date order by biz_date",scope.params()));return out;
    }
