...
public class ModuleRegistrar implements ApplicationRunner {
    ...
    @Override @Transactional public void run(ApplicationArguments ignored){
        String[][] roles={{"ADMIN","系统管理员"},{"BOSS","老板"},{"DEPT_HEAD","部门负责人"},{"TEAM_LEAD","小组负责人"},{"OPS","运营"},{"ADS_BUYER","投流投手"},{"MARKET_LEAD","市场负责人"},{"MARKET_MEMBER","剪辑"},{"DIRECTOR","编导"},{"SHOOTER","拍摄"}};
